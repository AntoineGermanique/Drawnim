...
var giveFeedback = function giveFeedback(a) {
  return feedback.innerHTML = a;
};
...
var drawStart = function drawStart(e) {
  console.log('force', e);
  painting = true;
...
var drawStop = function drawStop(e) {
  painting = false;
};

var drawMove = function drawMove(e) {
  if (painting) {
    mouseX = e.pageX ? e.pageX : e.touches[0].pageX - this.offsetLeft;
    mouseY = e.pageY ? e.pageY : e.touches[0].pageY - this.offsetTop; // find all points between        
    ...
    e.touches && e.touches[0] ? pressureVal = e.touches[0].force * 2 : pressureVal = 1;
